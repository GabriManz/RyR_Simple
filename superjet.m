...
% Superjet is a general function for colormap building. It was originally
% built back in the days where jet was the default colormap and was aimed
% at extending jet to include black and white.
...
%
% superjet(N,colors); returns an N-by-3 matrix of colour transitions between
%           however many input character codes where input:
%
%   k - black     y - yellow    m - magenta    t - turquoise   j - jade
%   u - purple    o - orange    v - violet     i - indigo      a - amber
%   b - blue      r - red       s - salmon     d - denim       e - emerald
%   c - cyan      p - pink      n - brown      f - flesh       h - heat
%   g - green     w - white     l - lime       x - xenon       q - quartz
%
%          numbers imput as character codes produce shades of gray.
%
%   Example calls:
%
...
%%%
if(exist('colorDictddd.mat','file')==2)
    load('colorDict.mat');
else
